...
/**
 * Classe qui sous-hérite de la classe Case
 * Définie la classe de type Destination
 */
public class Destination extends Case {

    /*** Constructeur de la sous-classe Case : Destination
    ...
    public Destination(String caracter, boolean player, boolean box , boolean isBlock){ 
    ...
    /**
     * Constructeur par default de Destination
     */
    public Destination(){
