/**
 * @file MainReaderScene.h
 * @author Alexis Bernard & Antoine Wybo
 * @brief Programme qui permet de compiler et retourner le résultat d'une scene.
 * @date 1.01.2023
 * @version 1.0
 */

#ifndef _MAINREADERSCENE_H_
#define _MAINREADERSCENE_H_ 1
